...
import (
	// "errors"
	"fmt"
	"github.com/ma2ma/godxf/block"
	"github.com/ma2ma/godxf/color"
	"github.com/ma2ma/godxf/drawing"
	"github.com/ma2ma/godxf/entity"
	"github.com/ma2ma/godxf/header"
...
// ParseLine parses LINE entities.
func ParseOther(d *drawing.Drawing, data [][2]string) (entity.Entity, error) {
	l := entity.NewCircle()
	return l, nil
}
